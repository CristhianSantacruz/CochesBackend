...
import com.klashz.api.coches.exception.UnauthorizedException;
...
public class JwtAuthFilter extends OncePerRequestFilter {
     ...
     */
    private List<String> urlsToSkip = List.of("/auth", "/swagger-ui.html", "/swagger-ui", "/api-docs","/customer/id","/customer/id/","/customer/update");
